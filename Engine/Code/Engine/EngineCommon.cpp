...
//--------------------------------------------------------------------------------------------------------------
void LogAndShowPrintf( const char* messageFormat, ... )
{
	va_list variableArgumentList;

	va_start( variableArgumentList, messageFormat );
	Logger::vaPrint( DEFAULT_FILTER, messageFormat, variableArgumentList );

	va_start( variableArgumentList, messageFormat );
	g_theConsole->vaPrint( messageFormat, variableArgumentList );

	//va_end called inside each above function.
}


//--------------------------------------------------------------------------------------------------------------
void LogAndShowPrintfWithTag( const char* tag, const char* messageFormat, ... )
{
	va_list variableArgumentList;

	va_start( variableArgumentList, messageFormat );
	Logger::vaPrint( tag, messageFormat, variableArgumentList );
