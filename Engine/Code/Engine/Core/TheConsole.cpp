...
//--------------------------------------------------------------------------------------------------------------
void TheConsole::vaPrint( const char* messageFormat, va_list variableArgumentList )
{
...
void TheConsole::Printf( const char* messageFormat, ... )
{
	...
	vaPrint( messageFormat, variableArgumentList );
}


//--------------------------------------------------------------------------------------------------------------
void TheConsole::ShowConsole()
{
	m_isVisible = true;

	g_theInput->OnLostFocus();
	g_theInput->DisplayCursor();
}


//--------------------------------------------------------------------------------------------------------------
void TheConsole::HideConsole()
{
	m_isVisible = false; 
	HidePrompt();

	FIXME( "What's causing the delay and weird behavior in Show/HideCursor + OnLost/GainedFocus?" );
