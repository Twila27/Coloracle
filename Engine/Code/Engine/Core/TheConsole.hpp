...
public:
	...
	void vaPrint( const char* messageFormat, va_list variableArgumentList );
	...
	double GetConsoleLeft() const { return m_consoleX; }
	double GetConsoleBottom() const { return m_consoleY; }
	double GetConsoleWidth() const { return m_consoleWidth; }
	Vector2f GetCurrentLogBoxTopLeft() const { return m_currentLogBoxTopLeft; } //Shows what's been typed.
	Vector2f GetCurrentPromptBoxTopLeft() const { return m_currentPromptBoxTopLeft; } //What you type into.
