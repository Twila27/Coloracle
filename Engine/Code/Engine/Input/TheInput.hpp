...
public:
	...
	bool IsButtonDown( ControllerButtons buttonID, Controllers controllerID = Controllers::CONTROLLER_ONE ) const;
	...
	void DisplayCursor();
	void HideCursor();
	void ToggleCursor() { m_isCursorVisible = !m_isCursorVisible; }
