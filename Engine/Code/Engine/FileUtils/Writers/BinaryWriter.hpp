...
class BinaryWriter abstract //See BytePacker for a tool that writes backwards instead of creating a data copy.
{
public:
	...
	{
		ArrayDataType dataCopy = value; //We don't want to byte-swap the original (as also forbidden by cont).
			//See BytePacker for a no-copy implementation.
