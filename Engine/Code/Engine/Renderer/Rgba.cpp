...
STATIC const Rgba Rgba::HALF_OPAQUE_WHITE = Rgba( 1.f, 1.f, 1.f, 0.5f );
...
//--------------------------------------------------------------------------------------------------------------
Rgba::Rgba( const char* colorName )
{
	std::string caseFreeNameStr = GetAsLowercase( colorName );
	const char* caseFreeNameCStr = caseFreeNameStr.c_str();

	if ( strcmp( caseFreeNameCStr, "red" ) == 0 )
		*this = Rgba::RED;
	else if ( strcmp( caseFreeNameCStr, "green" ) == 0 )
		*this = Rgba::GREEN;
	else if ( strcmp( caseFreeNameCStr, "black" ) == 0 )
		*this = Rgba::BLACK;
	else if ( strcmp( caseFreeNameCStr, "darkgray" ) == 0 )
		*this = Rgba::DARK_GRAY;
	else if ( strcmp( caseFreeNameCStr, "gray" ) == 0 )
		*this = Rgba::GRAY;
	else if ( strcmp( caseFreeNameCStr, "white" ) == 0 )
		*this = Rgba::WHITE;
	else if ( strcmp( caseFreeNameCStr, "blue" ) == 0 )
		*this = Rgba::BLUE;
	else if ( strcmp( caseFreeNameCStr, "magenta" ) == 0 || strcmp( caseFreeNameCStr, "purple" ) == 0 )
		*this = Rgba::MAGENTA;
	else if ( strcmp( caseFreeNameCStr, "yellow" ) == 0 )
		*this = Rgba::YELLOW;
	else if ( strcmp( caseFreeNameCStr, "cyan" ) == 0 )
		*this = Rgba::CYAN;
}
...
//--------------------------------------------------------------------------------------------------------------
STATIC Rgba Rgba::GetRandomColor( float alphaOpacity /*= 1.f*/ )
{
	return Rgba( GetRandomFloatZeroTo( 1.f ), GetRandomFloatZeroTo( 1.f ), GetRandomFloatZeroTo( 1.f ), alphaOpacity );
}


//--------------------------------------------------------------------------------------------------------------
STATIC Rgba Rgba::AverageColors( const Rgba& a, const Rgba& b )
{
