...
#define LOGGER_OUTPUT_TO_CONSOLE

#define LOG_FILE_NAME		"debug"
...
//SD6 A1 TCP RemoteCommandService
#define AUTOSTART_REMOTE_COMMAND_SERVICE //Will try to auto-join on program start, or host if that fails.
