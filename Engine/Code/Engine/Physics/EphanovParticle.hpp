...
public:
	...
	void GetEphanovParticleState( LinearDynamicsState3D& out_state ) const;
	void SetEphanovParticleState( LinearDynamicsState3D* newState ) { m_state = newState; }
	void Render();
