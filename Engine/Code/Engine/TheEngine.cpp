...
//--------------------------------------------------------------------------------------------------------------
void TheEngine::RunFrame( bool shouldRender /*= true*/ )
{
...
//			this->Render(); //How will this work for VR if client renders itself? Need to retool all of this...
...
void TheEngine::RenderDebug3D()
{
	...
	TheEventSystem::Instance()->TriggerEvent( "TheGame::RenderDebug3D" );
}
...
void TheEngine::RenderDebug2D()
{
	...
	TheEventSystem::Instance()->TriggerEvent( "TheGame::RenderDebug2D" );
...
void TheEngine::Render()
{
	...
	TheEventSystem::Instance()->TriggerEvent( "TheGame::Render3D" );
	if ( g_inDebugMode )
		this->RenderDebug3D();
	...
	TheEventSystem::Instance()->TriggerEvent( "TheGame::Render2D" );
	...
	//-----------------------------------------------------------------------------
	g_theRenderer->RenderAllScreenText();
